...
class TestUpdateInfo(TestCase):
    def setUp(self):
        ...
        self.test_user.save()
        self.test_info = Info(user=self.test_user, phone='N/A',type='SU', skills='')
        self.test_info.save()

    def test_update_success(self):
        result = updateInfo(self.test_user, 'test', 'mctestface', '555-5555', 'Testing', '')
    ...
    def testing_update_null_info(self):
        result = updateInfo(self.test_user, None, None, None, None, None)
        self.assertFalse(result, 'updateInfo fails to return false for null input.')

    def testing_update_no_user(self):
        result = updateInfo(None, 'test', 'mctestface', '555-5555', 'Testing', '')
